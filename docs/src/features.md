...
Floating point values, resources (`res`), custom/user-defined types,
collections, filesystem access, modules, project configuration, and lockfile
semantics are deferred. Milestone 9's lightweight compatibility, diagnostic,
...
the lowering stage rather than silently approximated.
