...
retention remain follow-up refinements. Declaration-site labels are available
for selected semantic errors. Conservative multi-error recovery has started for
undefined-variable and undefined-function diagnostics in `check`; broader
